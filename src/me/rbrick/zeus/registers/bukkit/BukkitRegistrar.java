            ...
            if(m.isAnnotationPresent(Command.class)) {
                ...
                if(command.name().equalsIgnoreCase(name)) {
                    ...
                    try {
                        ...
                        org.bukkit.command.Command command1 = (ZeusCommand) commandConstructor.newInstance(command.name(), command.desc(), command.usage(), Arrays.asList(command.aliases()), obj);
